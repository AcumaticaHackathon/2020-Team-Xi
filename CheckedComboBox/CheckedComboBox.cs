    ...
    public class CheckedComboBox : ComboBox
    {
        ...
        internal class Dropdown : Form
        {
            ...
            public Dropdown(CheckedComboBox ccbParent)
            {
                ...
                this.cclb.Click += new EventHandler(this.cclb_Click);
            }
            ...
            public void CloseDropdown(bool enactChanges)
            {
                ...
                ccbParent.TopLevelControl.BringToFront();
            }
            ...
            private void cclb_Click(object sender, EventArgs e)
            {
                //ccbParent.Click?.Invoke(sender, e);
            }
        ...
        public void SetCheckedItems(string text)
        {
            List<string> vals = new List<string>();
            vals.AddRange(text.Split(ValueSeparator.ToCharArray()));
            for (int i = 0; i < Items.Count; i++)
            {
                var item = (CCBoxItem)Items[i];
                if (item != null && !string.IsNullOrWhiteSpace(item.Name.Trim()))
                    if (vals.Contains(item.Name))
