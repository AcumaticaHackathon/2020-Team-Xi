...
if([System.String]::IsNullOrWhiteSpace($version) -eq $true)
{
    if(($args.Count>0) -and ([System.String]::IsNullOrWhiteSpace($args[0]) -eq $true))
        {
        ...
        {
            $version=$args[0];
            Write-Host ('Version {0} found' -f $version)
...
if(Test-Path $targetDir)
{
 ...
 Write-Host ('MSIFile {0} found' -f $msiFile)
 Write-Host ('TargetDir {0} found' -f $targetDir)
...
Write-Host " "
Write-Host "==================================================================" -foregroundcolor $writeHostColor
Write-Host ("=====    MSI Args {0}" -f [system.String]::Join(" ",$MSIArguments)) -foregroundcolor $writeHostColor
Write-Host "==================================================================" -foregroundcolor $writeHostColor
Write-Host " " 
Write-Host " "
